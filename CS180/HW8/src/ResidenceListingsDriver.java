        ...
        do {
            ...
            if (mainMenuSelection == null) {
                ...
                if (residenceType.equals(residenceTypeFindSelections[0])) {
                    ...
                    for (int i = 0; i < rl.getNumResidences() ; i++) {
                        int res = JOptionPane.showOptionDialog(null, rl.getResidences()[i].toString(), "Find a listing",
                                JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, doneNextButtons, doneNextButtons[1]);
                        if (res == 0) {
                            break;
                        } else {
                            continue;
                    ...
                    for (int i = 0; i < rl.getNumResidences() ; i++) {
                        int res1 = JOptionPane.showOptionDialog(null, rl.getResidences()[i].toString(), "Find a listing",
                                JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, doneNextButtons, doneNextButtons[1]);
                        if (res1 == 0) {
                            break;
                        } else {
                    ...
                    for (int i = 0; i < rl.getNumResidences() ; i++) {
                        int res2 = JOptionPane.showOptionDialog(null, rl.getResidences()[i].toString(), "Find a listing",
                                JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, doneNextButtons, doneNextButtons[1]);
                        if (res2 == 0) {
                            break;
                        } else {
