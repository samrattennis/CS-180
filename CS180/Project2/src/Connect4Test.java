...
public class Connect4Test {
    ...
    public void testConstructor()  {
        try {
            ...
            for (int i = 0; i < 6; i++) {
                Assert.assertArrayEquals(message, expected[i], actual[i]);
            }
        } catch(IllegalAccessException|NoSuchFieldException e) {
            Assert.assertFalse("Make the board variable a char array named 'board'", true);
        } catch(Exception e) {
            Assert.assertFalse("An exception occurred", true);
            e.printStackTrace();
        }
    ...
    public void testGetBoardNew()  {
        try {
            ...
            for (int i = 0; i < 6; i++) {
                Assert.assertArrayEquals(message, expected[i], actualCopy[i]);
            }
            message = "Ensure that getBoard() returns a copy of the board";
            Assert.assertNotSame(message, actualBoard, actualCopy);
        } catch(IllegalAccessException|NoSuchFieldException e) {
            Assert.assertFalse("Make the board variable a char array named 'board'", true);
        } catch(Exception e) {
            Assert.assertFalse("An exception occurred", true);
    ...
    public void testPutPieceX()  {
        try {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                Assert.assertEquals(message, expectedRow, actualRow);
            }
            ...
            for (int i = 0; i < 6; i++) {
                Assert.assertArrayEquals(message, expectedBoard[i], actualBoard[i]);
            }
        }  catch(IllegalAccessException|NoSuchFieldException e) {
            Assert.assertFalse("Make the board variable a char array named 'board'", true);
        } catch(Exception e) {
    ...
    public void testCheckAlignmentVertX()  {
        try {
            ...
            for (int i = 2; i < 6; i++) {
                actual = (char) c.checkAlignment(i, 0);
                Assert.assertEquals(message, expected, actual);
            }
        }  catch(IllegalAccessException|NoSuchFieldException e) {
            Assert.assertFalse("Make the board variable a char array named 'board'", true);
